...
urlpatterns = [
    ...
    path('customer/rate-technician/<int:request_id>/', views.customer_rate_technician, name='customer_rate_technician'),
    path('customer/report-issue/<int:request_id>/', views.customer_report_issue, name='customer_report_issue'),
    ...
    path('technician/tracking-location/<int:id>/', views.technician_tracking_location, name='technician_tracking_location'),
    path('customer/tracking/<int:id>/', views.customer_tracking, name='customer_tracking'),
    path('customer/tracking/<int:id>/location/', views.customer_tracking_location, name='customer_tracking_location'),
   ...
   path('send-verification-email/',views.send_verification_email,name='send_verification_email'),
    ...
    path('super-admin/assistant/query/', admin_views.admin_assistant_query_api, name='admin_assistant_query'),
